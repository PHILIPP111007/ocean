...
/* Real C names emitted by the Ocean compiler for class Request/Response. */
typedef struct ocean_Request ocean_Request;
typedef struct ocean_Response ocean_Response;

/* Public route handlers are ordinary Ocean functions: Request -> Response. */
typedef ocean_Response *(*ocean_web_handler_t)(ocean_Request *request);

/* Bridge functions emitted from std/net/web.oc by the Ocean compiler. */
