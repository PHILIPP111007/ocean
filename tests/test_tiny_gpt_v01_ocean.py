...
def test_tiny_gpt_v01_training(tmp_path):
    root = Path(__file__).resolve().parents[1]
    source = root / "examples/ML/tiny_gpt_v01.oc"
    c_path = tmp_path / "tiny_gpt_v01.generated.c"
    binary = tmp_path / "tiny_gpt_v01"
    ...
    assert "[ok] ocean tinygpt v0.1" in stdout
