...
class Validator:
    ...
    def collect_symbols(self, scopes: List[Mapping]):
        ...
        for scope_idx, scope in enumerate(scopes):
                    ...
                    self.external_c_functions.update(
                        {
                            ...
                            "ocean_tensor_set_flat",
                            "ocean_tensor_get_flat_bool",
                            "ocean_tensor_get_flat_i8",
                            "ocean_tensor_get_flat_i16",
                            "ocean_tensor_get_flat_i32",
                            "ocean_tensor_get_flat_i64",
                            "ocean_tensor_get_flat_u8",
                            "ocean_tensor_get_flat_u16",
                            "ocean_tensor_get_flat_u32",
                            "ocean_tensor_get_flat_u64",
                            "ocean_tensor_get_flat_f16",
                            "ocean_tensor_get_flat_f32",
                            "ocean_tensor_get_flat_f64",
                            "ocean_tensor_set_flat_bool",
                            "ocean_tensor_set_flat_i8",
                            "ocean_tensor_set_flat_i16",
                            "ocean_tensor_set_flat_i32",
                            "ocean_tensor_set_flat_i64",
                            "ocean_tensor_set_flat_u8",
                            "ocean_tensor_set_flat_u16",
                            "ocean_tensor_set_flat_u32",
                            "ocean_tensor_set_flat_u64",
                            "ocean_tensor_set_flat_f16",
                            "ocean_tensor_set_flat_f32",
                            "ocean_tensor_set_flat_f64",
                            "ocean_tensor_len",
                            "ocean_tensor_copy",
                            "ocean_tensor_ternary_quantize",
                            "ocean_tensor_ternary_scale",
                            "ocean_tensor_ternary_pack",
                            "ocean_tensor_gelu",
                            "ocean_tensor_gelu_backward",
                            "ocean_tensor_copy_into",
                            "ocean_tensor_cache_write",
            "ocean_paged_kv_cache_create",
            "ocean_paged_kv_cache_create_with_capacity",
                            "ocean_paged_kv_cache_release",
            ...
            "ocean_paged_kv_cache_build_summaries",
            "ocean_paged_kv_cache_update_summary",
            "ocean_paged_kv_cache_build_hierarchy",
            "ocean_paged_kv_cache_update_hierarchy",
            "ocean_paged_kv_cache_build_route_hierarchical",
            "ocean_paged_kv_cache_update_route_hierarchical",
                            "ocean_tensor_argmax",
                            ...
                            "ocean_tensor_sparse_attention_build_hierarchy",
                            ...
                            "ocean_tensor_packed_qkv_attention_decode",
                            "ocean_tensor_binary",
                            "ocean_tensor_scalar",
                            ...
                            "ocean_tensor_fill",
                            "ocean_tensor_get_nd",
                            "ocean_tensor_get_nd_bool",
                            "ocean_tensor_get_nd_i8",
                            "ocean_tensor_get_nd_i16",
                            "ocean_tensor_get_nd_i32",
                            "ocean_tensor_get_nd_i64",
                            "ocean_tensor_get_nd_u8",
                            "ocean_tensor_get_nd_u16",
                            "ocean_tensor_get_nd_u32",
                            "ocean_tensor_get_nd_u64",
                            "ocean_tensor_get_nd_f16",
                            "ocean_tensor_get_nd_f32",
                            "ocean_tensor_get_nd_f64",
                            "ocean_tensor_set_nd",
                            "ocean_tensor_set_nd_bool",
                            "ocean_tensor_set_nd_i8",
                            "ocean_tensor_set_nd_i16",
                            "ocean_tensor_set_nd_i32",
                            "ocean_tensor_set_nd_i64",
                            "ocean_tensor_set_nd_u8",
                            "ocean_tensor_set_nd_u16",
                            "ocean_tensor_set_nd_u32",
                            "ocean_tensor_set_nd_u64",
                            "ocean_tensor_set_nd_f16",
                            "ocean_tensor_set_nd_f32",
                            "ocean_tensor_set_nd_f64",
                            "ocean_tensor_get_2d",
                            "ocean_tensor_set_2d",
                            "ocean_tensor_shape",
                            "ocean_tensor_ndim",
